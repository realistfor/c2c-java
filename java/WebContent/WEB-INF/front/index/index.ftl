<script type="text/javascript" src="${base}/common/default/js/funcs.js"></script>
<div id="bodyer">
...
<table width="954px" cellpadding="0" cellspacing="0" style="margin-top: 5px" class="picstyle">
  <tr><td><a href="${adv.linkUrl}"><img src="${base}/photoserver/photo/${adv.picUrl}" title="${adv.title}" width="100%"/></a></td></tr>
 </table>
</c:forEach>
...
<script type="text/javascript" src="${base}/root/common/default/js/couplet.js"></script>
...
<!--
    ...
    if(showad){
	var ClosebuttonHtml = '<div align="right" style="position: absolute;top:0px;right:0px;margin:2px;padding:0px;z-index:2000;"><a href="javascript:void(0)" onclick="hidead()" style="color:black;text-decoration:none;font-size:12px;"><img src="${base}/common/default/images/close.gif"/></a></div>'
	var AdContentHtml = '<div align="center" style="color:green;font-size:23pt;font-family:黑体;"><a href="${COUPLET.linkUrl}" target="_blank"><img src="${base}/photoserver/photo/${COUPLET.picUrl}" width="110px" border="0"></a></div>';
    ...
    if(dataArray!="undefined" || dataArray != null){
        for(var i in dataArray){
                     ...
                     imgs.src = '${base}/photoserver/photo/' + data.img;
                     imgs.alt = data.alt;
